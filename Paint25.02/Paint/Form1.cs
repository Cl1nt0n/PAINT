...
namespace Paint
{
    public partial class paint : Form
    {
        ...
        enum tools { Empty, Line, Rectangle, Ellipse, Erase, Text, Pencil };
        ...
        private void paint_Load(object sender, EventArgs e)
        {
            ...
            pencil = new SolidBrush(colorDialog.Color);
            ...
            if (canDraw == true)
            {
                ...
                switch (currentTools)
                {
                    ...
                    case tools.Text:
                        break;
                    case tools.Pencil:
                        graphics.FillRectangle(pencil, e.X - eraseSize / 2, e.Y - eraseSize / 2, eraseSize, eraseSize);
                        saveBitmap = (Bitmap)currentBitmap.Clone();
                        break;
                }
        ...
        private void загрузитьToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                //sizeCoefWidth = pictureBox.Width / saveBitmap.Width;
                //sizeCoefHeight = pictureBox.Height / saveBitmap.Height;
            }
        }
